...
func (c *identityClient) Hello(ctx context.Context, in *Status, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/quantos.pkg.v1.Identity/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityClient) Bye(ctx context.Context, in *ByeMsg, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/quantos.pkg.v1.Identity/Bye", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Identity_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/quantos.pkg.v1.Identity/Hello",
	}
...
func _Identity_Bye_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/quantos.pkg.v1.Identity/Bye",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
